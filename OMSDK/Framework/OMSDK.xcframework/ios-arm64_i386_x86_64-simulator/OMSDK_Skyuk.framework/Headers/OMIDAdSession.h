 ...
 */
@interface OMIDSkyukAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDSkyukAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDSkyukAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDSkyukAdSessionContext *)context
