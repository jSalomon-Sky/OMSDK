 ...
 */
@interface OMIDSkyukAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDSkyukPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDSkyukPartner *)partner
                               ...
                               resources:(NSArray<OMIDSkyukVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
