 ...
 */
@interface OMIDNbcuni1AdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDNbcuni1AdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDNbcuni1VASTProperties *_Nonnull)vastProperties
