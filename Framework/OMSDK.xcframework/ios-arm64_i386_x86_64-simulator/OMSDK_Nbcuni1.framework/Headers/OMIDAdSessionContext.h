 ...
 */
@interface OMIDNbcuni1AdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDNbcuni1Partner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDNbcuni1Partner *)partner
                               ...
                               resources:(NSArray<OMIDNbcuni1VerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
